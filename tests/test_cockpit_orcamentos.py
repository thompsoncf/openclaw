...
create table titulos (id bigserial primary key, conta_id bigint not null,
  ...
  recorrente boolean not null default false, periodicidade text, valor_variavel boolean not null default false, acrescimo_centavos int not null default 0, lancamento_acrescimo_id bigint, categoria text not null default '',
